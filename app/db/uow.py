...
from app.roles_permissions.repository import RolePermissionRepository
...
class UOW:
    ...
    roles_permissions: RolePermissionRepository
    ...
    async def on_open(self) -> None:
        ...
        self.roles_permissions = RolePermissionRepository(self.session)
